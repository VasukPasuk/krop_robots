    ...
    <section id="robot-sumo-full-info-block">
      <div ref={containerRef} className={`robot-sumo-full-info-block__text-block`}>
        ...
        <div className={`paragraph-box-4 p-b-item-4`}>
          ...
          час раунду минув і не один із роботів не торкнувся поверхні за межами подіуму, то програє раунд той робот, що
          знаходиться далі від центру поля, ніж робот супротивника.
          
          <div>Якщо переможець не може бути визначений способами, описаними вище, рішення про перемогу або
            перегравання
            раунду приймає суддя змагання.</div>
        ...
        <div className={`paragraph-box-5 p-b-item-5`}>
          <h2 id={PARAGRAPHS[3].anchorId}>Поведіка членів комад.</h2>
